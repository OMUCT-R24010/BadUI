            ...
            >
              <div className="min-w-[200%] space-y-4 text-sm text-gray-700">
                ...
                <p className="whitespace-normal">
                  当社は、お客様の個人情報を適切に管理し、以下の目的のために利用させていただきます。
                  当社は、個人情報保護法その他関連法令を遵守し、適切な取り扱いを行います。
                </p>
                
                <div className="min-w-[150%]">
                  <h3 className="font-bold text-lg">第1条（取得する個人情報）</h3>
                  <p className="whitespace-normal">
                    当社は、お客様から以下の個人情報を取得することがあります：氏名、メールアドレス、住所、電話番号、
                    生年月日、性別、職業、利用履歴、Cookie情報、IPアドレス、位置情報、その他サービス利用に必要な情報。
                    これらの情報は、サービスの提供、改善、お客様サポート、マーケティング活動などに使用されます。
                  </p>
                </div>
                ...
                <div className="min-w-[150%]">
                  ...
                  <p className="whitespace-normal">
                    取得した個人情報は、以下の目的で利用します：サービスの提供・運営、お客様からのお問い合わせへの対応、
                ...
                <div className="min-w-[150%]">
                  ...
                  <p className="whitespace-normal">
                    当社は、以下の場合を除き、お客様の個人情報を第三者に提供することはありません：お客様の同意がある場合、
                ...
                <div className="min-w-[150%]">
                  ...
                  <p className="whitespace-normal">
                    お客様は、当社に対して、個人情報保護法に定めるところにより、個人情報の開示、訂正、追加、削除、
                    利用停止等を請求することができます。請求方法については、当社のお問い合わせ窓口までご連絡ください。
                    当社は、本人確認を行った上で、合理的な期間内に対応いたします。
                  </p>
                </div>
